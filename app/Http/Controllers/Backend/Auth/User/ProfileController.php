...
class ProfileController extends Controller
{
    ...
    public function update(UpdateProfileRequest $request)
    {
        ...
        $output = $this->userRepository->update(
            $request->user()->id,
            $request->only('first_name','middle_name','name_suffix', 'last_name','dob', 'phone', 'gender', 'address', 'city', 'pincode', 'state', 'country', 'avatar_type', 'avatar_location'),
    ...
    public function updatePayPal(Request $request)
    {
        ...
        $user->paypal_address = $request->paypal;
        $user->save();
        return redirect()->route('admin.account')->withFlashSuccess('PayPal successfully updated.');
    }
}

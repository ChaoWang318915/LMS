...
trait UserAttribute
{
    ...
    public function getVerifyLabelAttribute()
    {
        if ($this->isImageVerify()) {
            return  '<a href="'.route(
                    'admin.auth.user.unverify',
                        $this
                ).'" data-toggle="tooltip" data-placement="top" title="UnVerified" name="verify_item"><span class="badge badge-success" style="cursor:pointer">'.'Yes</span></a>';
        }

        return '<a href="'.route('admin.auth.user.verify', $this).'" data-toggle="tooltip" data-placement="top" title="Verified" name="verify_item"><span class="badge badge-danger" style="cursor:pointer">'.'No</span></a>';
    }
     ...
     * @return string
     */
    public function getPaymentVerifyLabelAttribute()
    {
        if ($this->isPaymentVerify()) {
            return  '<a href="'.route(
                    'admin.auth.user.unpay_verify',
                        $this
                ).'" data-toggle="tooltip" data-placement="top" title="UnVerified" name="verify_item"><span class="badge badge-success" style="cursor:pointer">'.'Yes</span></a>';
        }

        return '<a href="'.route('admin.auth.user.pay_verify', $this).'" data-toggle="tooltip" data-placement="top" title="Verified" name="verify_item"><span class="badge badge-danger" style="cursor:pointer">'.'No</span></a>';
    }
    ...
    public function getFullNameAttribute()
    {
        return $this->last_name
            ? $this->first_name.' '.$this->middle_name.' '.$this->last_name.' '.$this->name_suffix
            : $this->first_name;
    }

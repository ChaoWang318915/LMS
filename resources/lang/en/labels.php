...
return array (
  ...
  array (
    ...
    array (
      ...
      'edit' => 'Edit Lesson',
      'view' => 'View Lessons',
      'video_guide' => '<p class="mb-1"><b>Upload :</b> Upload <b>mp4</b> file in file input</p>',
      'remove' => 'Remove',
    ),
    'categories' => 
    array (
...
<b>Live</b> = Will be used with you Live PayPal credentials to make actual transaction with normal users with PayPal account.',
      ...
      array (
        ...
        'desc' => 'Checked fields from the right sidebar will be displayed in registration form t',
        'fields' => 
        array (
          'first_name' => 'First Name',
          'last_name' => 'Last Name',
  ...
  array (
    ...
    array (
      ...
      'offline_payment' => 'Accept Terms & conditions',
      'offline_payment_note' => '<a href="/term-and-conditions" target="_blank">Get Terms & condition</a>',
      'request_assistance' => 'Get Now',
      'cart' => 'Cart',
      'checkout' => 'Checkout',
      ...
      'confirmation_note' => '<span style="display:none">By confirming this purchase, I agree to the <b>Term of Use, Refund Policy</b> and <b>Privacy Policy</b></span>',

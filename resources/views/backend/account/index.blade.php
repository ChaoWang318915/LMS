                ...
                <div class="card-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            @if($logged_in_user->hasRole('student'))
                            <li class="nav-item">
                                <a href="#paypal" class="nav-link" aria-controls="paypal" role="tab" data-toggle="tab">Update Paypal</a>
                            </li>
                            @endif
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade show pt-3" id="paypal" aria-labelledby="paypal-tab">
                                @include('backend.account.tabs.paypal')
                            </div><!--tab panel paypal-->

...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('validation.attributes.frontend.name_suffix'))->for('name_suffix') }}

            {{ html()->text('name_suffix')
                ->class('form-control')
                ->placeholder(__('validation.attributes.frontend.name_suffix'))
...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('validation.attributes.frontend.middle_name'))->for('middle_name') }}

            {{ html()->text('middle_name')
                ->class('form-control')
                ->placeholder(__('validation.attributes.frontend.middle_name'))
                ->attribute('maxlength', 191)
                ->required() }}
        </div><!--form-group-->
    </div><!--col-->

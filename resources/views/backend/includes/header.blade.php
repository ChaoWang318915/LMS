<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav d-md-down-none">
        ...
        <li class="nav-item px-3">
            <a class="nav-link" href="/wallet">@lang('navs.frontend.dashboard')</a>
        </li>
        ...
        <li class="nav-item px-3">
            <a class="nav-link" href="/courses">Purchase Courses</a>
        </li>
         @endif
      ...
      <!--   <li class="nav-item d-md-down-none">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            <span class="d-md-down-none">{{ $logged_in_user->first_name }} {{ $logged_in_user->last_name }} {{ $logged_in_user->name_suffix}}</span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            <div class="dropdown-header text-center">

...
<div class="sidebar">
    <nav class="sidebar-nav">
     ...
     <li class="nav-title">
            @if (!$logged_in_user->hasRole('affiliate'))
                My Acct# DCL-{{auth()->user()->uniqe_id}}-{{auth()->user()->id}}
            
            </li>
                <li class="nav-title">
                <span class="title">User Credits ( {{auth()->user()->credits}} )</span>
            </li>
            @endif
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/dashboard')) }}"
                   href="{{ route('admin.dashboard') }}">
                    <i class="nav-icon icon-book-open"></i> My Courses
                </a>
            </li>
            @endif
            ...
            @else
                ...
                @endcan
            @endif
            @if (!$logged_in_user->hasRole('student') && !$logged_in_user->hasRole('affiliate')  )
            <li class="nav-item ">
            ...
            @if ($logged_in_user->hasRole('student') || $logged_in_user->hasRole('affiliate'))
                ...
                <!--<li class="nav-item ">
                 ...
                 @if (!$logged_in_user->hasRole('affiliate'))
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'rewards-program' ? 'active' : '' }}"
                       href="{{ route('students.rewards-program') }}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title">Reward Programs</span>
                    </a>
                </li>
                @else
                <li class="nav-item ">
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'invite-student' ? 'active' : '' }}"
                       href="{{route('students.invite-student')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title" style="color:deepskyblue;">Invite Now!</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'payment-history' ? 'active' : '' }}"
                       href="{{route('students.payment-history')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title">Payment History</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'order-history' ? 'active' : '' }}"
                       href="{{route('students.order-history')}}">
                        <i class="nav-icon icon-credit-card"></i>
                 ...
                 <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'terms-condition' ? 'active' : '' }}"
                       href="{{route('students.terms-condition')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title">Credit Terms</span>
                    </a>
                </li>
                
                 <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'program-description' ? 'active' : '' }}"
                       href="{{route('students.program-description')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title">Learn How</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'customer-service' ? 'active' : '' }}"
                       href="{{route('students.customer-service')}}">
                        <i class="nav-icon icon-credit-card"></i>
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'affiliate-terms' ? 'active' : '' }}"
                       href="{{route('students.affiliate-terms')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title">Affiliate Terms</span>
                    </a>
                </li>
               
                @if($logged_in_user->verify_status == 1 && $logged_in_user->confirmed == 1 && $logged_in_user->f_pay_status == 1)
                <li class="nav-item  {{ $request->segment(2) == 'account-verify' ? 'active' : '' }}">
                    <a class="nav-link"
                       href="{{route('students.account-verify')}}">
                        <i class="nav-icon icon-credit-card"></i>
                        <span class="title" style="color:deepskyblue;font-weight: bold;">ACCOUNT VERIFIED</span>
                    </a>
                </li>
                @else 
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'account-verify' ? 'active' : '' }}"
                       href="{{route('students.account-verify')}}">
                        <i class="nav-icon icon-credit-card"></i>
            ...
            @if ($logged_in_user->isAdmin())
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/auth*'), 'open') }}">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/image-verify*')) }}"
                               href="{{ route('admin.auth.user.image-verify') }}">
                                 Image Verification
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/payment-verify*')) }}"
                               href="{{ route('admin.auth.user.payment-verify') }}">

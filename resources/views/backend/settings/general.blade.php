                        ...
                        <div class="col-lg-9 input-boxes col-12">
                            <div class="form-group">
                                <input type="text" readonly
                                       placeholder="{{__('labels.backend.general_settings.user_registration_settings.fields.name_suffix')}}"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" readonly
                            ...
                            <div class="form-group">
                                <input type="text" readonly
                                       placeholder="{{__('labels.backend.general_settings.user_registration_settings.fields.middle_name')}}"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" readonly
                            ...
                            <div class="form-group">
                                <input type="text" readonly
                                       placeholder="{{__('labels.backend.general_settings.user_registration_settings.fields.social_security_number')}}"
                                       class="form-control">
                        ...
                        <div class="col-lg-3 border-left col-12">
                            <div class="form-group input-list">
                                ...
                                <div class="checkbox">
                                 ...
                                 <div class="checkbox">
                                    <label><input type="checkbox" checked disabled value="name_suffix" data-type="text" data-name="name_suffix"> {{__('labels.backend.general_settings.user_registration_settings.fields.name_suffix')}}</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" checked disabled value="middle_name" data-type="text" data-name="middle_name"> {{__('labels.backend.general_settings.user_registration_settings.fields.middle_name')}}</label>
                                </div>
                                <div class="checkbox">
                                ...
                                <div class="checkbox">
                                    <label><input type="checkbox" checked disabled value="social_security_number" data-type="text" data-name="social_security_number"> {{__('labels.backend.general_settings.user_registration_settings.fields.social_security_number')}}</label>
                                </div>
                                <div class="checkbox">

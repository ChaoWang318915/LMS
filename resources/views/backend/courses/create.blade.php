...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row"> @if (Auth::user()->isAdmin())
                ...
                <div class="row">
                    <div class="col-md-12 form-group" style="display:none;">
                        ...
                        {!! Form::select('media_type', ['upload' => 'Upload'],null,['class' => 'form-control', 'placeholder' => 'Select One','id'=>'media_type' ]) !!}

...
@section('title', app_name() . ' | ' . 'Image Verification')
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.auth.user.getPaymentVerifyData')}}';
            var myTable = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    {data: "verify_label", name: "verify_label"},
                    {data: "payment_verify_label", name: "payment_verify_label"},

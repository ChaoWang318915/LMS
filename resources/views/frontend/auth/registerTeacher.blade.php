                ...
                <div class="col-sm-12">
                    <div class="card  border-0">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="payment_method" id="payment_method" required style="pointer-events: none;">
                                            <option value="bank" {{ old('payment_method') == 'bank'?'selected':'' }}>{{ trans('labels.teacher.bank') }}</option>
                                            <option value="paypal" {{ old('payment_method') == 'paypal'?'selected':'' }} selected>{{ trans('labels.teacher.paypal') }}</option>
                                        </select>
                                    </div><!--form-group-->
                                </div><!--col-->
                            </div><!--row-->
                            ...
                            <div class="paypal_details" style="display: block;">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">

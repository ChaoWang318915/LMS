                        ...
                        <div class="order-item mb30 course-page-section">
                            ...
                            <div class="course-list-view table-responsive">
                                <table class="table">
                                    ...
                                    @if(count($courses) > 1)
                                        @php
                                        //    cart.remove['course'=>$course[0]]);
                                       // $userId = auth()->user()->id; // or any string represents user identifier
                                       //Cart::session($userId)->remove($courses[1]->id);
                                        ...
                                        @if(config('payment_offline_active') == 1)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                         • By enrolling, you are agreeing to finance this course.<br><br>
                                                         • The full cost of this training will be deducted from your credit line.<br><br>
                                                          
                                                          • If you have credits available, one credit will be deducted instead.<br><br> 

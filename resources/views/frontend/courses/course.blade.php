...
@push('after-styles')
    <style>
        ...
        #course-details > div > div > div.col-md-3 > div > div.side-bar-widget{
            display:none;
        }
...
@endpush
    ...
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 offset-md-8">
       ...
       <a href="/registration_user"> <button class="top_grid_button_reg"><i class="fa fa-user" aria-hidden="true"></i>
        ...
        @else
         <a href="/logout"> <button class="top_grid_button_reg"><i class="fas fa-sign-out-alt" aria-hidden="true"></i>
        </i>
        logout</button></a>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        <div class="course-single-pic mb30" style="text-align: center;">
                            @if($course->course_image != "")
                                <img id="preview_img" src="{{asset('storage/uploads/'.$course->course_image)}}"
                                     alt="" style="width:auto;height:400px;">
                            @endif
                            <video width="100%" height="400" id="lesson_video" autoplay controls style="display:none">
                                                ...
                                                <div class="panel-title" id="headingOne">
                                                    <div class="ac-head">
                                                        ...
                                                        <button class="btn btn-link collapsed" data-toggle="collapse"
                                                                ...
                                                                aria-controls="collapse{{$count}}"  @if($purchase_flag != 0 && $lesson->url != '' ) onClick="replaceVideo('{{$lesson->url}}')" @endif>

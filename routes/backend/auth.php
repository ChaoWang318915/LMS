...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        * Image Verify
        */
        Route::get('image-verify', [UserController::class, 'imageVerify'])->name('user.image-verify');
        Route::get('user/get-verify-data', [UserController::class, 'getImageVerifyData'])->name('user.getImageVerifyData');
        /*
        * First Pyament Verify
        */
        Route::get('payment-verify', [UserController::class, 'paymentVerify'])->name('user.payment-verify');
        Route::get('user/get-payment-data', [UserController::class, 'getPaymentVerifyData'])->name('user.getPaymentVerifyData');
        /*
         * Specific User
         */
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            //Image Verify
            Route::get('verify', [UserConfirmationController::class, 'verify'])->name('user.verify');
            Route::get('unverify', [UserConfirmationController::class, 'unverify'])->name('user.unverify');
            
            //Payment Verify
            Route::get('pay_verify', [UserConfirmationController::class, 'pay_verify'])->name('user.pay_verify');
            Route::get('unpay_verify', [UserConfirmationController::class, 'unpay_verify'])->name('user.unpay_verify');
